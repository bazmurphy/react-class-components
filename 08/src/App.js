...
class App extends React.Component {
  ...
  add = () => {
    ...
    // you can make this a one liner arrow with implicit return
    // but we have to wrap the object we are returning in () so it doesnt confuse the {} with the function body
